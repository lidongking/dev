...
function sys_windows()
{
    ...
    $cpuinfo = GetWMI($wmi, "Win32_Processor", array(
        "Name",
        "L2CacheSize",
        "NumberOfCores",
    ));
    ...
    $swapinfo = GetWMI($wmi, "Win32_PageFileUsage", array(
        'AllocatedBaseSize',
        'CurrentUsage',
    ));
        ...
        <table>
            ...
            <?php for ($i = 2; $i < count($strs); $i ++) : ?>
                ...
                <tr>
                    ...
                    <td width="29%">入网:
                        <font color='#CC0000'><span id="NetInput<?php echo $i ?>"><?php echo $NetInput[$i] ?></span></font></td>
                    <td width="14%">实时: <font color='#CC0000'><span id="NetInputSpeed<?php echo $i ?>">0B/s</span></font></td>
                    <td width="29%">出网: <font color='#CC0000'><span id="NetOut<?php echo $i ?>"><?php echo $NetOut[$i] ?></span></font>
                    </td>
